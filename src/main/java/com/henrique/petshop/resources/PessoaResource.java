...
import com.henrique.petshop.dto.PessoaDTO;
import com.henrique.petshop.service.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<List<PessoaDTO>> findAll() {
		...
		List<PessoaDTO> listaDto = list.stream().map(obj -> new PessoaDTO(obj)).collect(Collectors.toList());
